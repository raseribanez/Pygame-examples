...
# This demonstrates keeping track of users mouse activity in Pygame
...
while True:
    ...
    if keys[K_ESCAPE]:
        sys.exit()
    "More Python Programming 66 gramming for the Absolute Beginner"
    screen.fill((0,100,0))
    ...
    print_text(font1, 0, 200, "Mouse button: " + str(b1) + "," + str(b2) + "," + str(b3))
