# Ben Woodfield
# A game that calculates letters per minute based on typing speed
# This only allows one letter words at the moment
...
pygame.display.set_caption("Keyboard Speed Tester")
